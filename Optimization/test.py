...
print("椭圆曲线:", curve.name)
print()
print("p:", hex(curve.p))
print("a:", hex(curve.a))
print("b:", hex(curve.b))
print()
print("基点横坐标x:", hex(curve.g[0]))
print("基点纵坐标y:", hex(curve.g[1]))
print("椭圆曲线的阶n:", hex(curve.n))
private, public = make_keypair()
print()
print("私钥:", hex(private))
print("公钥: (0x{:x}, 0x{:x})".format(*public))
